...
export default function Banner() {
  return (
    <section className="relative overflow-hidden bg-muted min-h-140 sm:min-h-160 lg:min-h-172 flex flex-col justify-center pt-12 sm:pt-16 lg:pt-20 pb-20 sm:pb-28 lg:pb-36">
